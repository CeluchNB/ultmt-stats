...
export const POINT_ALREADY_EXISTS = 'This point already exists.'
...
export const PLAYER_NOT_FOUND = 'This user does not exist.'
export const TEAM_NOT_FOUND = 'This team does not exist.'
export const CONNECTION_NOT_FOUND = 'This connection does not exist.'
export const ALL_POINTS_NOT_RECEIVED = 'This game is missing points.'
